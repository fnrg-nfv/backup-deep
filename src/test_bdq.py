    ...
    for it in range(0, ITERATIONS):
        ...
        if load_model:
            ...
            with open(topo_file_name, 'rb') as f:
                ...
                sfc_list = generate_sfc_list(topo=topo, process_capacity=process_capacity, size=sfc_size,
        ...
        fail_rate, real_fail_rate, throughput, service_time, total_reward, accept_num, place_num, accept_rate, place_cdf = report(
            model)
